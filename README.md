...
# Installation
Extract Anno1800ModMenuDX11.dll, Anno1800ModMenuDX12.dll and TextShaping.dll to ...\Anno 1800\Bin\Win64. Then just run the game.
To show the menu you can hit F7 when you are at main menu or in game.

# Usage


Forked from: https://github.com/ChrisAnd1998/Anno1800ModMenu

The mod menu uses Dear ImGui to render the gui.
